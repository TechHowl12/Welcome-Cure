      ...
      <div className="w-full sm:w-10/12 flex flex-col lg:flex-row items-center gap-8 lg:gap-16 py-8 lg:py-12">
        ...
        <div className="w-full text-left lg:px-0 px-auto">
          <div className="space-y-3">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl 2xl:text-7xl text-white leading-tight">
              Deploying Across<br />The Eco-System
            </h1>
            <p className="text-gray-300 mt-4 text-sm sm:text-lg ml-2">
              Join the future with us now. Get in touch<br />
              to know more
            </p>
          </div>
          
          <div className="w-full flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-8 mt-3">
